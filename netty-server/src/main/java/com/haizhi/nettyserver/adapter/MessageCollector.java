package com.haizhi.nettyserver.adapter;

import com.haizhi.nettyserver.handler.IMessageHandler;
import com.haizhi.nettyserver.server.DemoServer;
...
public class MessageCollector extends ChannelInboundHandlerAdapter {
    ...
    public MessageCollector(int workerThreads) {
        ...
        this.executor = new ThreadPoolExecutor(1, workerThreads,
                ...
                (runnable, poolExecutor) -> log.error(Thread.currentThread().getId() + "任务大小超出队列上线"));
    }
